...
1. uint8类型，或叫 byte型，代表ASCII码的一个字符 (uint8 == byte)
2. rune类型，代表一个 utf-8 字符(rune == int32) 可以点进去看原码。
...
ret := "chenglh广东省广州市"
fmt.Println([]uint8(ret))
fmt.Println([]int32(ret)) //英文或数字所在的编码 uint8与int32是相同的，但是中文的编码就不一样了
//[99 104 101 110 103 108 104 229 185 191 228 184 156 231 156 129 229 185 191 229 183 158 229 184 130]
//[99 104 101 110 103 108 104 24191 19996 30465 24191 24030 24066]
fmt.Printf("%c\n", 24191)
~~~
